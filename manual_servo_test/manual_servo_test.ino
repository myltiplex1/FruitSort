...
#define DELAY_MS 20      // Delay between steps (ms)
...
void setup() {
  ...
  Serial.println("3DOF Arm Servo Control (Manual Input Mode)");
  ...
  Serial.println("Enter commands like: BASE:90 or SHOULDER:120 or GRIP:45");
}
...
// Smooth movement function (minimal modification)
